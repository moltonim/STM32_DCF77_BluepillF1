...
namespace Internal {
    namespace Generic_1_kHz_Generator {
        ...
        void setup(const Clock::input_provider_t input_provider) {
            // 
			      // based on STM32DUINO hardware timer library example
			      // https://github.com/stm32duino/wiki/wiki/HardwareTimer-library
			      //

            // configure timer to for 1us ticks and rollover at 1000 ticks (i.e. 1ms)
            // example clock freq for STM32F103 bluepill is 72'000'000 so prescaler is 72
